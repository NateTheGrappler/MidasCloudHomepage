...
const users = 
{
    ...
    insertRequestData(username, email, optionalRequest)
    {
        return database.prepare(`
            INSERT INTO users (username, email, status, reasonForRequest) VALUES (?, ?, ?, ?)
            `).run(username, email, 'pending', optionalRequest);
    },
